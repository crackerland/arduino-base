...
//#define TFTWIDTH   240
//#define TFTHEIGHT  320 Moved to *TFTLCD.h
...
void Adafruit_TFTLCD::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h, uint16_t fillcolor) {
  ...
  y1 = _height - y1;//Flip Y
  y2 = _height - y2;//Flip Y

  setAddrWindow(x1, y2, x2, y1); //Flip y1 and y2 to fix fill direction
